...
Given('abro la página principal de Multicine', async function () {
  await this.page.goto('https://www.multicine.com.bo', { waitUntil: 'networkidle' });
});
...
When('selecciono la ciudad {string}', async function (city) {
  ...
  const optionLocator = this.page.locator(
    '.dropdownBody.open .dropdownItem',
    { hasText: city },
  ).first();
...
Then('debería ver la opción de {string} en el filtro de ubicación', async function (city) {
